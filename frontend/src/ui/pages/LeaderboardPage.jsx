...
export default function LeaderboardPage() {
  ...
  return (
    <div className="pb-4">
      <div className="px-4 pt-12 pb-8" style={{ background: 'linear-gradient(135deg, #7C3AED 0%, #6D28D9 100%)' }}>
      ...
      <div className="px-4 pt-4 flex flex-col gap-2">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-700">
          <p className="text-[11px] text-gray-400 uppercase tracking-wider px-4 pt-4 pb-2">Все участники</p>
          {leaders.map((entry, i) => (
